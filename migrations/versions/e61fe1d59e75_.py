...
Revision ID: e61fe1d59e75
Revises: 
Create Date: 2019-06-20 10:37:37.570000
...
def upgrade():
    ...
    sa.Column('operation_resources_id', sa.String(length=100), nullable=True),
    ...
    sa.Column('cpu_cores', sa.String(length=128), nullable=True),
