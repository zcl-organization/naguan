...
class BaseConfig(object):
    ...
    SESSION_TYPE = 'redis'
    SESSION_REDIS = redis.Redis(host='192.168.12.108', port='6379', password='123456')
    SESSION_PERMANENT_SESSION_LIFETIME = 3600
    SESSION_KEY_PREFIX = 'flask'
    # CELERY_IMPORTS = ('tasks.add',)
    CELERY_BROKER_URL = 'redis://:123456@192.168.12.108:6379/1'
    CELERY_RESULT_BACKEND = 'redis://:123456@192.168.12.108:6379/1'
...
class DevelopConfig(BaseConfig):
    ...
    SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://naguan1:123456@192.168.12.108:3306/naguan1?charset=utf8'
